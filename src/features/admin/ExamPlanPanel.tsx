...
const WEEK_TEMPLATES: Record<number, TaskTemplate[]> = {
  ...
  1: [ // 1주 전
    ...
    { key:"day_before", label:"전날 최종 정리", detail:"핵심 포인트 한 장 정리 + 멘탈 관리", icon:<CheckCircle size={14}/>, color:"#059669", bg:"#d1fae5" },
  ],
};
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:16, flexWrap:"wrap", gap:10 }}>
        <div>
          <h2 style={{ margin:0, color:"#7c3aed", display:"flex", alignItems:"center", gap:8 }}>
            <Calendar size={22} color="#7c3aed" /> 시험대비 계획
          </h2>
