...
echo ============================================
echo   ASX Student Recorder Lite  -  실행 중...
echo ============================================
echo.
...
if not exist .env (
  ...
  (
    echo VITE_ADMIN_ACCESS_CODE=PVPHPJ
    echo VITE_ADMIN_PASSWORD=OuQBQoczGX
...
echo ============================================
echo   관리자 접속 코드 : PVPHPJ
echo   관리자 비밀번호   : OuQBQoczGX
echo   ^(앱 제목을 5번 연속 탭하면 접속 코드 입력창이 뜹니다^)
echo ============================================
echo.
